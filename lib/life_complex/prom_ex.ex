defmodule LifeComplex.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule LifeComplexWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :life_complex
  ...
  use PromEx, otp_app: :life_complex
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: LifeComplexWeb.Router, endpoint: LifeComplexWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
      ...
      # LifeComplex.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:life_complex, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
